    ...
    public function process(Vtiger_Request $request)
    {
        ...
        $dummy_data = [
            [
                ...
                'warehouse'   => 'Malca-Amit Hong Kong (Hong Kong)',
                'description' => 'G_100_CB_P49',
                'itemDescription' => 'G_100_CB_P49',
                'totalFineOz'   =>  6.4296,
                "serials" => [
                    'AS:FNAF2-3',
                    'AS:FNBK1-3',
                ...
                'serialNumbers'  => "AS:FNAF2-3",
            ],
            [
                'quantity'  => 3,
                'spot_price' => 4612.95,
                "documentDate" => "2024-06-10",
                'warehouse'   => 'Malca-Amit Zurich (Switzerland)',
                'description' => 'G_50_CB_P21',
                'itemDescription' => 'G_50_CB_P21',
                'totalFineOz'   =>  3.2150,
                "serials" => [
                    'AS:FNEH1-2',
                    'AS:FNFI1-2',
                ...
                'serialNumbers'  => "AS:FNEH1-2",
            ],
            [
                'quantity'  => 2,
                'spot_price' => 4612.95,
                "documentDate" => "2024-06-10",
                'warehouse'   => 'Malca-Amit Dubai (UAE)',
                'description' => 'G_100_CB_P55',
                'itemDescription' => 'G_100_CB_P55',
                'totalFineOz'   =>  4.0320,
                "serials" => [
                    'AS:FNHJ1-2',
                    'AS:FNHK1-2',
            ...
            [
                ...
                'serialNumbers'  => "AS:FNNB1-4",
            ]
        ];

        // Add dummy data as std objects
