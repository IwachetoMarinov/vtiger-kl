...
class Contacts_SaleOrderView_View extends Vtiger_Index_View
{
    ...
    function downloadPDF($html, Vtiger_Request $request)
    {
        ...
        $pdf->SetXY(32, 140.5); // A4 coords are in mm
        $pdf->TextField(
            'serial_numbers',
            $serial_input_widthw,
            $h,
        ...
        $pdf->SetXY(53.5, 159.0); // A4 coords are in mm
        $pdf->TextField(
            'pick_up_location',
            127.0,
            $h,
        ...
        $pdf->SetXY(74, 167.5); // A4 coords are in mm
        $pdf->TextField(
        ...
        $pdf->SetXY(141.5, 167.5); // A4 coords are in mm
        $pdf->TextField(
        ...
        // bank_name input
        $pdf->SetXY(52, 204.5); // A4 coords are in mm
        $pdf->TextField(
            'bank_name',
            128,
            $h,
        ...
        // bank_address input
        $pdf->SetXY(55, 211.5); // A4 coords are in mm
        $pdf->TextField(
            'bank_address',
            127,
            $h,
        ...
        // bank_code input
        $pdf->SetXY(52, 218.7); // A4 coords are in mm
        $pdf->TextField(
            'bank_code',
            51,
            $h,
        ...
        // swift_code input
        $pdf->SetXY(122, 218.7); // A4 coords are in mm
        $pdf->TextField(
            'swift_code',
            55,
            $h,
        ...
        // account_no input
        $pdf->SetXY(52, 224.7); // A4 coords are in mm
        $pdf->TextField(
            'account_no',
            47,
            $h,
        ...
        $pdf->SetXY(126, 224.7); // A4 coords are in mm
        $pdf->TextField(
            'account_currency',
            49,
            $h,
