...
class Contacts_SaleOrderView_View extends Vtiger_Index_View
{
    ...
    function downloadPDF($html, Vtiger_Request $request)
    {
        ...
        $pdf->SetXY(32, 142.5); // A4 coords are in mm
        $pdf->TextField(
            'serial_numbers',
            $serial_input_widthw,
            $h,
        ...
        $pdf->SetXY(53.5, 161.0); // A4 coords are in mm
        $pdf->TextField(
            'pick_up_location',
            127.0,
            $h,
        ...
        $pdf->SetXY(74, 169.5); // A4 coords are in mm
        $pdf->TextField(
        ...
        $pdf->SetXY(141.5, 169.5); // A4 coords are in mm
        $pdf->TextField(
        ...
        // bank_name input
        $pdf->SetXY(52, 206.5); // A4 coords are in mm
        $pdf->TextField(
            'bank_name',
            128,
            $h,
        ...
        // bank_address input
        $pdf->SetXY(55, 213.5); // A4 coords are in mm
        $pdf->TextField(
            'bank_address',
            127,
            $h,
        ...
        // bank_code input
        $pdf->SetXY(52, 220.7); // A4 coords are in mm
        $pdf->TextField(
            'bank_code',
            51,
            $h,
        ...
        // swift_code input
        $pdf->SetXY(122, 220.7); // A4 coords are in mm
        $pdf->TextField(
            'swift_code',
            55,
            $h,
        ...
        // account_no input
        $pdf->SetXY(52, 226.7); // A4 coords are in mm
        $pdf->TextField(
            'account_no',
            47,
            $h,
        ...
        $pdf->SetXY(126, 226.7); // A4 coords are in mm
        $pdf->TextField(
            'account_currency',
            49,
            $h,
