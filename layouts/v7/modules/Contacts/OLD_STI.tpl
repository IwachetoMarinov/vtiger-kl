        ...
        {if $smarty.request.PDFDownload neq true}
            ...
            <ul style="list-style-type: none;
                ...
                <li style="float:right">
                    <a style="display: block;color: white;text-align: center;padding: 14px 16px;text-decoration: none;background-color: #bea364;" href="index.php?module=Contacts&view=DocumentPrintPreview&record={$RECORD_MODEL->getId()}&docNo={$smarty.request.docNo}&PDFDownload=true&bank={$SELECTED_BANK->getId()}">Download</a>
                </li>
                ...
                <table class="print-tbl">
                    <tr>
                        <td  style="height: 28mm;">
                            <img src='layouts/v7/modules/Contacts/resources/gpm-new-logo.png' style="max-height: 100%; float:right">
                    ...
                    <tr>
                        <td  style="font-size: 9pt; height: 168mm; vertical-align: top;">
                            ...
                            <div>
                                ...
                                Account No:  {$SELECTED_BANK->get('account_no')} {$SELECTED_BANK->get('account_currency')}<br>
