...
<ul style="list-style-type:none;margin:0;padding:0;overflow:hidden;background-color:#333;">
    <li style="float:right">
        <a style="display:block;color:white;text-align:center;padding:14px 16px;text-decoration:none;background-color:#bea364;"
            href="index.php?module=Contacts&view=DocumentPrintPreview&record={$RECORD_MODEL->getId()}&docNo={$smarty.request.docNo}&PDFDownload=true&hideCustomerInfo={$smarty.request.hideCustomerInfo}">
            Download
        </a>
    </li>
</ul>
        ...
        <td style="font-size:9pt;height:168mm;vertical-align:top;">
            ...
            <table class="activity-tbl">
                ...
                {foreach item=barItem from=$ERP_DOCUMENT.barItems}
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            {number_format($barItem.pureOz,3)}
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right">
                        <strong>{number_format($calcTotal,3)}</strong>
                    </td>
                </tr>
