...
{if $ENABLE_DOWNLOAD_BUTTON}
        <ul style="list-style-type: none;
                ...
                background-color: #bea364;" href="index.php?module=Contacts&view=ActivtySummeryPrintPreview&record={$RECORD_MODEL->getId()}&ActivtySummeryDate={$smarty.request.ActivtySummeryDate}&PDFDownload=true">Download</a></li>
        </ul>
{/if}
                                ...
                                {/for}
                                    ...
                                    {if $PAGES eq $page}
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td style="text-align:right"><strong>{if $movementTotal gte 0 }{number_format($movementTotal,2, '.', ',')}{else}({number_format(abs($movementTotal),2, '.', ',')}){/if}</strong></td>
                                            <td></td>
                                        </tr>
                                        <tr>
