        ...
        <div class="">
            ...
            {foreach key=INDEX item=LINE from=$RELATED_PRODUCTS}
                <div class="col-md-12 item_infromation_input item_{$INDEX+1}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-12">
                            <input type="text" class="form-control item_value_usd"  id="value_usd_{$INDEX+1}" name="value_usd[]" value="{$LINE->get('value_usd')|number_format:4:'.':','}" readonly=true>
                        </div>
                        <div class="col-md-1 col-sm-3 col-xs-12">
                        </div>
                    </div>
            ...
            <div class="col-md-12 item_infromation_total" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-12">
                    {if $MODE eq 'edit'}
                        <input type="text" class="form-control" id="total_amount" name="total_amount" value="{$RECORD->get('total_amount')|number_format:4:'.':','}" readonly required="">
                    {else}
